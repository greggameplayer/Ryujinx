...
namespace ARMeilleure.CodeGen.X86
{
    static class IntrinsicTable
    {
        ...
        static IntrinsicTable()
        {
            ...
            Add(Intrinsic.X86Crc32,      new IntrinsicInfo(X86Instruction.Crc32,      IntrinsicType.UnaryToGpr));
            Add(Intrinsic.X86Crc32_16,   new IntrinsicInfo(X86Instruction.Crc32_16,   IntrinsicType.UnaryToGpr));
            Add(Intrinsic.X86Crc32_8,    new IntrinsicInfo(X86Instruction.Crc32_8,    IntrinsicType.UnaryToGpr));
